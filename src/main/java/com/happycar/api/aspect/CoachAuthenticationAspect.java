...
@Aspect
@Component
public class CoachAuthenticationAspect {
	 ...
	 * @throws Throwable 
     */
    @Around(value="execution(* com.happycar.api.controller.coach.*.*(..))")
    public Object validIdentityAndSecure(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if(authentication!=null){
        	...
        	HcCoach coach = coachDao.findOne(Integer.parseInt(pid));
        	request.setAttribute(Constant.KEY_LOGIN_COACH, coach);
        }
