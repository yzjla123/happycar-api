...
/**
 * The persistent class for the hc_position database table.
 * 
 */
@Entity
@Table(name="hc_position")
@NamedQuery(name="HcPosition.findAll", query="SELECT h FROM HcPosition h")
public class HcPosition implements Serializable {
